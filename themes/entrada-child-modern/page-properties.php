...
<?php get_template_part( 'template-parts/banner', 'search' ); ?> -->
    <main id="main">    	
		<?php 
		echo do_shortcode('[vc_row wrapper_container="content-block-no-padding-margin" css=".vc_custom_1463557718312{background-color: #ffffff !important;}" notification=""][vc_column][rev_slider alias="parallax-zoom-slices5"][/vc_column][/vc_row]'); ?>

        <?php
		get_template_part( 'search-templates/search', $layout ); ?>	
    </main>
